...
from sqlalchemy import Column, Integer, String, Float, Date, Boolean, JSON, ForeignKey, PrimaryKeyConstraint
...
class Station(Base):
    ...
    # Beziehungen
    measurements = relationship("DailyMeasurement", back_populates="station", cascade="all, delete-orphan")
