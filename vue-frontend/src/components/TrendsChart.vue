  ...
  <div class="trends-chart-container">
    ...
    <div v-else-if="chartData" class="space-y-6">
      ...
      <div v-if="trendAnalysis" class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        >
          <div class="text-sm text-green-600 font-semibold uppercase">
            Pro Jahr
          </div>
        ...
        >
          <div class="text-sm text-orange-600 font-semibold uppercase">
            Pro Dekade
          </div>
...
const loadTrendsData = async () => {
  ...
  try {
    ...
    error.value =
      err instanceof Error ? err.message : "Fehler beim Laden der Trend-Daten";
