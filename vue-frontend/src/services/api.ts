...
class ApiService {
  ...
  async getStations(params?: {
    ...
    const response: AxiosResponse<ApiResponse<Station[]>> =
      await this.client.get("/v1/stations", { params });
    return response.data;
  }

  async getStation(id: string): Promise<ApiResponse<Station>> {
    const response: AxiosResponse<ApiResponse<Station>> = await this.client.get(
      `/v1/stations/${id}`,
    );
    return response.data;
  }
  ...
  async searchStations(query: string): Promise<ApiResponse<Station[]>> {
    const response: AxiosResponse<ApiResponse<Station[]>> =
      await this.client.get(`/v1/stations/search/${query}`);
    return response.data;
  }
  ...
  async getMeasurements(params?: {
    ...
    const response: AxiosResponse<ApiResponse<Measurement[]>> =
      await this.client.get("/v1/measurements", { params });
    return response.data;
  }

  async getMeasurementsByStation(
    stationId: string,
    params?: {
      start_date?: string;
      end_date?: string;
    ...
    const response: AxiosResponse<ApiResponse<Measurement[]>> =
      await this.client.get(`/v1/measurements/station/${stationId}`, {
        params,
      });
    return response.data;
  }
  ...
  async getMeasurementsByDateRange(params: {
    ...
    const response: AxiosResponse<ApiResponse<Measurement[]>> =
      await this.client.get("/v1/measurements/date-range", { params });
    return response.data;
  }
  ...
  async getStationStatistics(stationId: string): Promise<ApiResponse<any>> {
    const response: AxiosResponse<ApiResponse<any>> = await this.client.get(
      `/v1/statistics/station/${stationId}`,
    );
    return response.data;
  }
  ...
  async getYearlyAggregates(params: {
    ...
    const response: AxiosResponse<ApiResponse<any>> = await this.client.get(
      "/v1/statistics/yearly-aggregates",
      { params },
    );
    return response.data;
  }
  ...
  async getMonthlyAggregates(params: {
    ...
    const response: AxiosResponse<ApiResponse<any>> = await this.client.get(
      "/v1/statistics/monthly-aggregates",
      { params },
    );
    return response.data;
  }
  ...
  async getMapStations(): Promise<ApiResponse<any>> {
    const response: AxiosResponse<ApiResponse<any>> =
      await this.client.get("/v1/maps/stations");
    return response.data;
  }
  ...
  async getClusterData(params: { zoom: number }): Promise<ApiResponse<any>> {
    const response: AxiosResponse<ApiResponse<any>> = await this.client.get(
      "/v1/maps/clusters",
      { params },
    );
