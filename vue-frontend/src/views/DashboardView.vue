  ...
  <div class="dashboard">
    ...
    <div class="mb-12 text-center animate-fade-in">
      ...
      <p class="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
        Visualisierung täglicher Klimadaten von 16 deutschen Wetterstationen vom
        Deutschen Wetterdienst. Zeitraum 1990–2024 mit über 2.3 Millionen
        Datensätzen.
      </p>
    </div>
    ...
    <!-- Stats Cards -->
    <div
      class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12 animate-slide-up"
    >
      <div class="card hover-lift">
        <div class="card-body">
          <div class="flex items-center">
            <div
              class="w-14 h-14 rounded-2xl bg-gradient-to-br from-primary-100 to-primary-200 flex items-center justify-center mr-4"
            >
      ...
      <div class="card hover-lift">
        <div class="card-body">
          <div class="flex items-center">
            <div
              class="w-14 h-14 rounded-2xl bg-gradient-to-br from-success-100 to-success-200 flex items-center justify-center mr-4"
            >
      ...
      <div class="card hover-lift">
        <div class="card-body">
          <div class="flex items-center">
            <div
              class="w-14 h-14 rounded-2xl bg-gradient-to-br from-warning-100 to-warning-200 flex items-center justify-center mr-4"
            >
      ...
      <div class="card hover-lift">
        <div class="card-body">
          <div class="flex items-center">
            <div
              class="w-14 h-14 rounded-2xl bg-gradient-to-br from-danger-100 to-danger-200 flex items-center justify-center mr-4"
            >
        ...
        <div class="card-body">
          <div class="space-y-4 scrollbar-thin max-h-96 overflow-y-auto">
            ...
            >
              <div class="flex items-center">
                <div
                  class="w-10 h-10 rounded-xl bg-gradient-to-br from-primary-50 to-primary-100 flex items-center justify-center mr-4 group-hover:scale-110 transition-transform"
                >
        ...
        <div class="card-body">
          <div class="space-y-4">
            ...
            >
              <div class="flex items-center">
                <div
                  class="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-100 to-blue-200 flex items-center justify-center mr-4 group-hover:scale-110 transition-transform"
                >
              ...
              <i
                class="pi pi-chevron-right text-gray-400 group-hover:text-primary-600 group-hover:translate-x-1 transition-all"
              ></i>
            </button>
            ...
            >
              <div class="flex items-center">
                <div
                  class="w-12 h-12 rounded-xl bg-gradient-to-br from-green-100 to-green-200 flex items-center justify-center mr-4 group-hover:scale-110 transition-transform"
                >
              ...
              <i
                class="pi pi-chevron-right text-gray-400 group-hover:text-success-600 group-hover:translate-x-1 transition-all"
              ></i>
            </button>
            ...
            >
              <div class="flex items-center">
                <div
                  class="w-12 h-12 rounded-xl bg-gradient-to-br from-amber-100 to-amber-200 flex items-center justify-center mr-4 group-hover:scale-110 transition-transform"
                >
              ...
              <i
                class="pi pi-chevron-right text-gray-400 group-hover:text-amber-600 group-hover:translate-x-1 transition-all"
              ></i>
            </button>
            ...
            >
              <div class="flex items-center">
                <div
                  class="w-12 h-12 rounded-xl bg-gradient-to-br from-purple-100 to-purple-200 flex items-center justify-center mr-4 group-hover:scale-110 transition-transform"
                >
              ...
              <i
                class="pi pi-chevron-right text-gray-400 group-hover:text-purple-600 group-hover:translate-x-1 transition-all"
              ></i>
            </button>
          </div>
        </div>
    ...
    <div class="card mb-12">
      <div class="card-header">
        ...
        <p class="text-sm text-gray-500 mt-1">
          Beispieldaten vom DWD Open Data Server
        </p>
      </div>
      <div class="card-body">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div
            class="text-center p-6 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200"
          >
          ...
          <div
            class="text-center p-6 rounded-2xl bg-gradient-to-br from-green-50 to-green-100 border border-green-200"
          >
          ...
          <div
            class="text-center p-6 rounded-2xl bg-gradient-to-br from-yellow-50 to-yellow-100 border border-yellow-200"
          >
