        ...
        <div class="flex flex-wrap gap-4 items-center">
          <div class="flex-1 min-w-[200px]">
            <label class="block text-sm font-medium text-gray-700 mb-2">{{
              $t("maps.controls.parameter")
            }}</label>
            <select v-model="selectedParameter" class="input-field">
              <option value="temperature">
                {{ $t("maps.parameters.temperature") }}
              </option>
              <option value="precipitation">
                {{ $t("maps.parameters.precipitation") }}
              </option>
              <option value="sunshine">
                {{ $t("maps.parameters.sunshine") }}
              </option>
            </select>
          </div>
          ...
          <div class="flex items-center gap-2">
            ...
            <button @click="toggleMapType" class="btn-secondary text-sm">
              <i
                class="pi"
                :class="
                  mapType === 'stations' ? 'pi-map-marker' : 'pi-chart-bar'
                "
              ></i>
              ...
              <div class="space-y-2">
                ...
                <div class="flex justify-between">
                  ...
                  <span class="font-medium"
                    >{{ selectedStation.elevation }} m</span
                  >
                </div>
                <div class="flex justify-between">
            ...
            <div>
              ...
              <div class="space-y-2">
                <div class="flex justify-between">
                  ...
                  <span class="font-medium"
                    >{{ selectedStation.lat.toFixed(4) }}°</span
                  >
                </div>
                <div class="flex justify-between">
                  <span class="text-gray-600">Längengrad:</span>
                  <span class="font-medium"
                    >{{ selectedStation.lon.toFixed(4) }}°</span
                  >
                </div>
                <div class="flex justify-between">
                  <span class="text-gray-600">Daten bis:</span>
                  <span class="font-medium">{{
                    selectedStation.latest_date || "2024-12-31"
                  }}</span>
                </div>
              </div>
            </div>
    ...
    <div class="card">
      <div class="card-header">
        ...
        <p class="text-sm text-gray-500 mt-1">
          Klicken Sie auf eine Station für Details
        </p>
      </div>
      <div class="card-body">
              ...
              >
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="flex items-center">
                    <div
                      class="w-8 h-8 rounded-lg bg-gradient-to-br from-primary-100 to-primary-200 flex items-center justify-center mr-3"
                    >
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                  ...
                  <button
                    @click="viewStationMeasurements(station)"
